...
=====================================
# Ansible-4 Локальная разработка Ansible ролей с Vagrant. Тестирование конфигурации.
=====================================
Установлено ПО для виртуализации и тестирования
Добавлен тест для роли db для порта 27017
Использованиы роли db и app в плейбуках packer
